...
(defrule oncle_tante
	(parent ?enf ?parent)
	(frere_et_soeur ?parent ?oncleOuTante)
=>
	(assert (oncle_tante ?enf ?oncleOuTante))
)

; Cousin ou cousine
(defrule cousin_cousine
	(oncle_tante ?enf1 ?oncle_tante)
